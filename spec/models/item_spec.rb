  ...
  describe '商品出品' do
    ...
    context '商品出品がうまくいかないとき' do
      ...
      it "配送料の負担の情報のidが1だと出品できない" do
        ...
        @item.valid?
        expect(@item.errors.full_messages).to include("Shipping burden must be greater than 1")
      end
      ...
      it "発送までの日数の情報のidが1だと出品できない" do
        ...
        @item.valid?
        expect(@item.errors.full_messages).to include("Shipping days must be greater than 1")
      end
